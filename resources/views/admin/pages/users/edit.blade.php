    ...
    <div class="col-md-12">
        ...
        <form action="" id="input-form">
            ...
            <div class="form-row">
                ...
                <button onclick="addAddress()" class="btn btn-primary btn-icon-split mb-3">
                    <span class="icon text-white-50">
                        <i class="fas fa-plus"></i>
                    </span>
                    <span class="text">Add address</span>
                </button>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" id="addressTable">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>City</th>
